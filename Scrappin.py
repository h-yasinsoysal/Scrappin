...
if __name__ == "__main__":
	parser = argparse.ArgumentParser(description='Scrappin - Linkedin Scraper Tool - Developed H.Y. Soysal')
	...
	empgroup = parser.add_argument_group(title="Employee Digging")
	...
	help="Create email addresses for discovered employees using a known format. (replace samplecompany with company name) [Accepted Formats: first.last@samplecompany.com, last.first@samplecompany.com, firstl@samplecompany.com, lfirst@samplecompany.com,\\ 		flast@samplecompany.com, lastf@samplecompany.com, first@samplecompany.com, last@samplecompany.com]")
